...
export type ListSelectionParams = {
    type:'listselection',
    defaultVal:string,
    numVisEntries:number,
    options:Array<ListSelectionEntry>
}

export type ListSelectionEntry = {id:string, name:string, disabled:boolean, tooltip?:string, state: "default"|"completed"|"error"}
export type TreeSelectionLeaf = {disabled:boolean, tooltip?:string, state:null|"completed"|"error"}
export type TreeSelectionNode = {[key:string]:TreeSelectionLeaf|TreeSelectionNode}
/**Parameters for a TreeSelection with a max depth of three selection*/
export type TreeSelectionParams = {
    type:'tree',
    defaultVal:string,
...
export type InputParams = SliderInputParams|TextInputParams|DropDownParams|CheckboxParams|SeparatorParams|TreeSelectionParams|ListSelectionParams
